...
public class WebDriverUtils {	
	...
	'Description		:	This function returns the all options of a combo box/list 
							
	'Parameters			:	Locator parameter is the object locator         		
	'#########################################################################################################*/
		public static String[] getOptions(WebDriver webdriver, String locator){
		  Select select = new Select(webdriver.findElement(locatorToByObj(webdriver, locator)));
		  String[] allOptions = new String[select.getOptions().size()];

		  for (int i=0;i<allOptions.length;i++)
		   allOptions[i]=select.getOptions().get(i).getText();
